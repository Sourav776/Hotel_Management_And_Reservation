...
{
    public partial class Soups : Form
    {
        MySqlConnection con = DAL.DatabaseConnect.Initialize();
        public Soups(string customer_id)
        {
            InitializeComponent();
        ...
        private void Soups_Load(object sender, EventArgs e)
        {
        ...
        private void CB1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total1.Text = (int.Parse(quantity1.Text) * 50).ToString();
        ...
        private void CB2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total2.Text = (int.Parse(quantity2.Text) * 60).ToString();
        ...
        private void CB3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total3.Text = (int.Parse(quantity3.Text) * 55).ToString();
        ...
        private void CB4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total4.Text = (int.Parse(quantity4.Text) * 70).ToString();
        ...
        private void CB5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total5.Text = (int.Parse(quantity5.Text) * 100).ToString();
