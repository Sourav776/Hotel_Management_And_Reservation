...
namespace hotel_managemnet_and_reservation_system.UI
{
    public partial class Drinks : Form
    {
        ...
        public Drinks(string customer_id)
        {
            InitializeComponent();
        ...
        private void meatBT_Click_1(object sender, EventArgs e)
        {
            Meats f = new Meats(cIdCB.Text);
            f.Visible = true;
            this.Close();
        }
        ...
        private void CB1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total1.Text = (int.Parse(quantity1.Text) * 20).ToString();
        ...
        private void CB2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total2.Text = (int.Parse(quantity2.Text) * 30).ToString();
        ...
        private void CB3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total3.Text = (int.Parse(quantity3.Text) * 15).ToString();
        ...
        private void CB4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total4.Text = (int.Parse(quantity4.Text) * 50).ToString();
        ...
        private void CB5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            total5.Text = (int.Parse(quantity5.Text) * 80).ToString();
        ...
        private void Drinks_Load(object sender, EventArgs e)
        {
            ...
            //con.Open();
            //string query = "select * from food_table where f_type='Drinks';";
            //try
            //{
            ...
            //    while (reader.Read())
            //    {
            //        id5.Text = reader.GetString(1);
            //        foodName5.Text = reader.GetString(2);
            //        price5.Text = reader.GetString(3);
            //    }
